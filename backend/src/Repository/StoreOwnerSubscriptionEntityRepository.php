...
class StoreOwnerSubscriptionEntityRepository extends ServiceEntityRepository
{
    ...
    public function getSubscriptionsPending()
    {
        return $this->createQueryBuilder('subscription')
            ...
            ->join(StoreOwnerEntity::class, 'userProfileEntity', Join::WITH, 'userProfileEntity.userID = subscription.ownerID')
    ...
    public function getRemainingOrders($ownerID, $id)
    {
        return $this->createQueryBuilder('subscription')
            ...
            ->leftJoin(StoreOwnerEntity::class, 'userProfileEntity', Join::WITH, 'userProfileEntity.userID = subscription.ownerID')
